  ...
  return (
    <div className="flex min-h-screen bg-safari-sand">
      ...
      <main className="flex-1 lg:ml-64 transition-all duration-300">
        <header className="h-16 bg-white/80 backdrop-blur-md border-b border-safari-earth/10 flex items-center justify-between px-4 lg:px-8 sticky top-0 z-40">
          <div className="flex items-center gap-4">
            <button 
              onClick={() => setIsSidebarOpen(true)}
              className="lg:hidden p-2 text-safari-earth hover:bg-safari-earth/5 rounded-lg transition-colors"
            >
              <Menu size={24} />
            </button>
